...
ابتدا، از مدل [YOLOE](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.7/deploy/pipeline/docs/tutorials/pphuman_mot_en.md) که بر روی مجموعه داده [crowdhuman]
(http://www.crowdhuman.org/)  به منظور ردیابی عابرین پیاده آموزش داده شده است، استفاده می کند.
