...
ابتدا، از مدل [YOLOE](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.7/deploy/pipeline/docs/tutorials/pphuman_mot_en.md) که بر روی مجموعه داده  https://www.crowdhuman.org)[crowdhuman]) به منظور ردیابی عابرین پیاده آموزش داده شده است، استفاده می کند.
